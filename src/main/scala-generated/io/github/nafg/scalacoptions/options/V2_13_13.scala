...
trait V2_13_13 extends V2_13_13_+ {
  /**
  ...
  /**
   * Boolean literals should be named args unless param is @deprecatedName.
   */
  def XlintNamedBooleans = List("-Xlint:named-booleans")
...
object V2_13_13 extends V2_13_13
