...
trait V3_6 extends V3 {
  ...
  /**
   * source version Default 3.6 Choices : 3.0-migration, 3.0, 3.1, 3.2-migration, 3.2, 3.3-migration, 3.3, 3.4-migration, 3.4, 3.5-migration, 3.5, 3.6-migration, 3.6, 3.7-migration, 3.7, future-migration, future, never
   */
