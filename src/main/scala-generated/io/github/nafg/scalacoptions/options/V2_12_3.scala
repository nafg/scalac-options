...
trait V2_12_3 extends V2_12_3_+ {
  /**
  ...
  /**
   * [:phases]                Run a GC between phases - this allows heap size to be accurate at the expense of more time. Specify a list of phases, or * <phases> (default: _)
   */
...
object V2_12_3 extends V2_12_3
